...
def ME(matrice):
    ...
    while m < total_ligne and n < total_colonne:
        ...
        for ligne in range(m + 1, total_ligne):
            ...
            valeur_init = matrice[ligne][
                n
            ]  # valeur situe a la meme colonne que le pivot
            ...
            for colonne in range(n, total_colonne):
                ligne_calcul[colonne] = (
                    (ligne_calcul[colonne] * pivot)
                    - (ligne_base[colonne] * valeur_init)
                ) / deno_commun
    ...
    if taille == 2:
        ...
        for pos in range(taille):
            ...
            for ligne in range(1, taille):
                ...
                for colonne in range(taille):
                    if colonne != pos:
                        mat_dict["mat" + str(pos)][ligne - 1].append(
        ...
        for pos in range(taille):
            ...
            det += (
                ((-1) ** (pos + 2))
                * matrice[0][pos]
                * calculDeterminant(mat, taille - 1)
            )
...
if __name__ == "__main__":
    ...
    choix = input(
        "Que voulez-vous calculer comme matrice?\n"
